...
def val():
    ...
    context.set_context(mode=context.GRAPH_MODE, device_target='GPU', device_id=cfg['device_id'], save_graphs=False)
    ...
    val_path = os.getenv('ckpt_url')
    param_dict = load_checkpoint(val_path)
